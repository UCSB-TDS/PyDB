...
class page_file:													# 1heap files contains many pages or only page?
	...
	def get_id(self,fileNAME):
		...
		self.page_id=hash(tempid[startp:-1])#hash the file's id
...
PF1.insert_tuple(T1)
print(tempid,tempdata)
#PF1.print_for_bugs()
'''
#operate with physical file
'''
...
print(len(bp1.pool_pages))
print(bp1.discard_page(1))
print(bp1.get_page(1))
ttemp=Tuple()
print(bp1.delete_tuple(T1.tuple_Rid,ttemp))
'''
